...
echo 正在尝试更新...
java -jar packwiz-installer-bootstrap.jar https://ghfast.top/raw.githubusercontent.com/MineOptimiz-Team/MineOptimiz-3rd/20.1/forge_pocket/overrides/pack.toml